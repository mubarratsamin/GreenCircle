...
if (isset($_GET['delete'])) {
    ...
    $stmt = $conn->prepare("DELETE FROM farmer_applications WHERE id = ?");
...
// Fetch applications with user_name via JOIN
$sql = "
SELECT fa.id, fa.experience, fa.skills, fa.photo, fa.applied_at, u.user_name AS applicant_name
...
<head>
    <meta charset="UTF-8" />
    <title>Manage Farmer Applications - GreenCircle Admin</title>
    <style>
        body {
...
<header>
    ...
    <nav>
        ...
        <a href="manage_farmers.php" style="color:#d0edd3;">Farmer Applications</a>
...
<main>
    <h1>Manage Farmer Applications</h1>
    ...
    <table>
        ...
        <?php while ($app = $result->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    <a class="delete-btn" href="manage_farmer_applications.php?delete=<?php echo $app['id']; ?>" onclick="return confirm('Are you sure you want to delete this application?');">Delete</a>
                </td>
            </tr>
        <?php endwhile; ?>
        </tbody>
